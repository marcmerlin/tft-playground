...
6 DC/A0 (data)		8	GPIO05/D1	27	27	BC23				
...
#define miso TFT_MISO // unused except for HWSPI init
...
void setup() {
    ...
    Serial.begin(115200);
    // Default is 40Mhz
    //tftSPI.begin(sclk, miso, mosi);
    display.begin();
    Serial.println("For extra speed, try 80Mhz (default 40Mhz), may be less stable");
